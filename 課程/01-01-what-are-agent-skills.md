...
這可能是初學者最困惑的部分。Agent Skills 跟 Tools、MCP、Plugins 到底有什麼不同？它們不是都在做「讓 Agent 更強」這件事嗎？

答案是：**它們解決的是不同層次的問題，且可以共存。**

<div class="diagram-responsive wide" style="margin: 1.5rem 0;">
  <img src="/images/skills-vs-ecosystem.svg" alt="Agent Skills vs MCP vs Tools vs Plugins 關係圖" />
  <p style="text-align:center;font-size:0.8em;color:var(--vp-c-text-2);margin-top:0.5rem">▲ 資料來源：agentskills.io · modelcontextprotocol.io</p>
</div>
